...
if __name__ == "__main__":
    ...
    while True:
        ...
        if(foundTemplate):
            ...
            cv2.imwrite('results/static_images/classified_tray_{0}.png'.format(trayCount),img_classified)
            ...
            cv2.imwrite('results/static_images/unclassified_tray_{0}.png'.format(trayCount),img_bgr)
